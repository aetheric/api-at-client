 ...
 */
public interface GetRoutesListByLongName {
	 ...
	 */
	@GET
	@Path("/routes/routeLongName/{route_long_name}")
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces(MediaType.APPLICATION_JSON)
	public Response getRoutesListByLongName(Request request);
